...
%$\rightarrow$ more general ongoing epistemological research on TQG: \cite{raimbault2017co} (TheoQuant 2017), \cite{raimbault2017invisible} (ECTQG 2017), \cite{raimbault2018extracting} (CCS 2018), \cite{raimbault:halshs-02284848} (ECTQG 2019), \cite{raimbault:halshs-02441891} (CCS 2019), cite{raimbault:hal-04257814} (ECTQG 2023)
...
\textit{Quantify some TQG corpuses in terms of knowledge domains, their use, diversity, and integration.}
...
\textbf{Corpus 2: } studies of Zipf's law for the size of cities, important theme in TQG but studied by various disciplines (economics, regional science, geography, physics), constructed by \cite{cottineau2017metazipf}.
...
% Zipf: 99756 nodes, 150611 edges ; core (deg >=30 !): 858 8143

$\rightarrow$ start from an initial corpus: \cite{pumain1997pour} and \cite{sanders1997simpop}; 39 papers for Zipf listed by \cite{cottineau2017metazipf}.

\bigskip

$\rightarrow$ reconstruct backward citations networks at depth 2, using the open data collection tools developped by \cite{raimbault2019exploration}: (16333 nodes and 21775 edges for Ev. Urb. Th.; 99756 nodes and 150611 edges for Zipf).

\bigskip

$\rightarrow$ extract core network by removing nodes of low degree (thresholds 3 and 30).

\bigskip

$\rightarrow$ corpuses for analysis to be annotated for domains: (1252,4950) Ev. Urb. Th.; (858,8143) Zipf.
...
%Counts for Zipf: /858
%    data empirical    method     model    theory 		NA
%        2       380        41       198       210 	27
%

$\rightarrow$ manually annotate each paper for its \textbf{main} knowledge domain.

\bigskip

$\rightarrow$ reviews and meta-analyses classified as ``theory''.

\bigskip

$\rightarrow$ machine learning approach not relevant with these corpus sizes.
...
\begin{tabular}{cccccccc}
	& 	data & empirical  &  method   &  model   & theory   &   tool   & NA \\
EUT	& 2    &   208   &    108    &   387    &   456   &     17   &  74 \\
Zipf &   2    &   380     &   41    &   198    &   210 &  0 &  27 \\
\end{tabular}
...
\includegraphics[width=0.48\linewidth]{../../../../Results/core_zipf.png}
\end{center}
...
\includegraphics[width=0.48\linewidth]{../../../../Results/zipf_communities-citations.png}
\end{center}
...
\textit{Composition of communities by Knowledge Domains for the EUT.}
...
Erfindahl diversity index, computed within each community:
...
\begin{tabular}{ccccccccc}
  ABM & CA & Complexity & GIS & LUTI & Other & Simpop & UrbSys & all \\
 0.65 & 0.61 & 0.66& 0.62 & 0.58 & 0.48 & 0.70 & 0.64 & 0.70 \\
\end{tabular}
...
\begin{tabular}{cccccccc}
  CityScience & CitySize & Finance & Method & NEG & Other & Simulation & all \\
 0.68 &  0.61 & 0.68 &  0.49 & 0.61 & 0.24 & 0.69 & 0.66 \\
\end{tabular}
...
\sframe{Results: citation flows between domains}{


\begin{center}
  \includegraphics[width=0.48\linewidth]{../../../../Results/evurbth_domaingraph.png}
  \includegraphics[width=0.48\linewidth]{../../../../Results/zipf_domaingraph.png}
\end{center}
...
%   - communities 0.365
%   - domains 0.06645351
%   - null -0.00117891 +- 0.004181261

Integration measured by modularity of knowledge domains:
...
\begin{itemize}
	\item Optimal communities: 0.496
	\item Knowledge domains: 0.0723
	\item Null model (100 bootstrap shuffling): $-0.0008 \pm 0.0049$
\end{itemize}
...
\begin{itemize}
	\item Optimal communities: 0.365
	\item Knowledge domains: 0.0664
	\item Null model: $-0.0011 \pm 0.0041$
\end{itemize}
...
\sframe{Results: key papers in the EUT}{
...
\begin{center}
\includegraphics[width=0.5\linewidth]{../../../../Results/zoom_evurbth_geodivercitydata.png}
\includegraphics[width=0.44\linewidth]{../../../../Results/zoom_evurbth_openmole.png}
\end{center}

Papers with a ``central'' role: tool paper \cite{reuillon2013openmole}, and ``data'' paper \cite{cura2017old}.
...
\textbf{Contributions: }
\begin{itemize}
	\item First quantitative approach to how knowledge domains interact
	\item Strong integration (low modularity) but still some structure (vs null model)
	\item Different interactions for EUT and Zipf
\end{itemize}
...
\begin{itemize}
	\item Machine learning models trained with the annotated data, for a systematic study of TQG (or more broadly urban science)
	\item Sensitivity analysis to initial corpuses and annotation noise
	\item Towards an endogenous construction of Knowledge Domains through functions of literature contributions?
	\item Similar work in progress on systematic model decomposition and mapping across a corpus
\end{itemize}

\smallskip

\textbf{Code and data: } \url{https://github.com/JusteRaimbault/GeoTheoQuantIntegration}
